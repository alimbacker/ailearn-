...
// ─── LOGO ───────────────────────────────────────────────────────────────────
const LOGO_FALLBACK = "data:image/png;base64,";
// Uses PHOTOS.logo when you set one, otherwise the bundled AllBee badge.
const LOGO_SRC = LOGO_FALLBACK;
...
const BEE_LEVELS = [
  { name: "Bronze Bee",  min: 0, color: "#b45309" },
  { name: "Silver Bee",  min: 250, color: "#64748b" },
  { name: "Gold Bee",    min: 700, color: "#d97706" },
  { name: "Diamond Bee", min: 1500, color: "#0891b2" },
  { name: "Queen Bee",   min: 3000, color: "#a855f7" },
];
...
const SKILL_TRACK = [
  { key: "python",  label: "Python",  match: ["python", "django", "flask"] },
  { key: "excel",   label: "Advanced Excel",  match: ["excel", "vlookup", "pivot", "formula"] },
  { key: "tally",   label: "Tally & GST",  match: ["tally", "gst", "journal", "ledger", "accounting"] },
  { key: "powerbi", label: "Power BI",  match: ["power bi", "powerbi", "dax", "dashboard"] },
  { key: "english", label: "Spoken English", match: ["english", "grammar", "speaking", "conversation"] },
  { key: "ai",      label: "AI Tools",  match: ["prompt", "chatgpt", "automation", "machine learning", "ai tool"] },
];
...
// ─── PHOTOS ─────────────────────────────────────────────────────────────────
// Drop your own pictures in here. Every value can be a normal web address
// ("https://yoursite.com/python.jpg"), a file you ship with the app
// ("/images/python.jpg"), or a data: URI. Anything you leave out falls back to
// the hexagon artwork below, so the app always looks complete.
//
//   logo   overrides the AllBee badge everywhere it appears
//   hero   wide banner across the top of the dashboard
//   any course id ("python", "excel", "tally"...) becomes that course's photo
const PHOTOS = {
  // logo:    "https://…/allbee-logo.png",
  // hero:    "https://…/classroom.jpg",
  // python:  "https://…/python-class.jpg",
  // excel:   "https://…/excel-training.jpg",
};

// ─── HEXAGON ARTWORK ────────────────────────────────────────────────────────
// AllBee is a bee, so every subject sits in a hive cell. The glyphs are drawn
// on a 24×24 grid and inherit the colour of the category they belong to.
const GLYPHS = {
  chip:      '<rect x="6" y="6" width="12" height="12" rx="2"/><path d="M10 2v4M14 2v4M10 18v4M14 18v4M2 10h4M2 14h4M18 10h4M18 14h4"/>',
  ...
  pen:       '<path d="M4 20l4.5-1L19 8.5a2.8 2.8 0 0 0-4-4L4.5 15z"/><path d="M14 6.5l4 4"/>',
  megaphone: '<path d="M3 10v4a1 1 0 0 0 1 1h3l7 4V5L7 9H4a1 1 0 0 0-1 1z"/><path d="M18 9a4 4 0 0 1 0 6"/>',
  camera:    '<rect x="2" y="6" width="14" height="12" rx="2"/><path d="M16 10l6-3v10l-6-3z"/>',
  briefcase: '<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2M2 13h20"/>',
  building:  '<path d="M3 21h18M5 21V5a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v16M15 21V11h4a2 2 0 0 1 2 2v8"/><path d="M9 7h2M9 11h2M9 15h2"/>',
  cap:       '<path d="M2 8l10-5 10 5-10 5z"/><path d="M6 10.5V16c0 1.7 2.7 3 6 3s6-1.3 6-3v-5.5M20 9v6"/>',
  grid:      '<rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M3 15h18M9 3v18"/>',
  terminal:  '<rect x="2" y="4" width="20" height="16" rx="2"/><path d="M6 9l3 3-3 3M12.5 15H17"/>',
  receipt:   '<path d="M5 3h14v18l-2.5-1.5L14 21l-2-1.5L10 21l-2.5-1.5L5 21z"/><path d="M9 8h6M9 12h6"/>',
  speech:    '<path d="M21 12a8 8 0 0 1-8 8H7.5L3 22.5V12a8 8 0 0 1 8-8h2a8 8 0 0 1 8 8z"/><path d="M8 11h8M8 15h4"/>',
  database:  '<ellipse cx="12" cy="6" rx="8" ry="3"/><path d="M4 6v6c0 1.7 3.6 3 8 3s8-1.3 8-3V6M4 12v6c0 1.7 3.6 3 8 3s8-1.3 8-3v-6"/>',
  brain:     '<path d="M9.5 3A3.5 3.5 0 0 0 6 6.5 3 3 0 0 0 4.5 12 3 3 0 0 0 6.5 17a3.5 3.5 0 0 0 5.5 2.9V4.5A1.5 1.5 0 0 0 10.5 3z"/><path d="M14.5 3A3.5 3.5 0 0 1 18 6.5a3 3 0 0 1 1.5 5.5A3 3 0 0 1 17.5 17a3.5 3.5 0 0 1-5.5 2.9"/>',
  bars:      '<path d="M3 21h18"/><rect x="5" y="12" width="4" height="7" rx="1"/><rect x="10.5" y="7" width="4" height="12" rx="1"/><rect x="16" y="3" width="4" height="16" rx="1"/>',
  mic:       '<rect x="9" y="2" width="6" height="12" rx="3"/><path d="M5 11a7 7 0 0 0 14 0M12 18v4M8.5 22h7"/>',
  doc:       '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6M8 13h8M8 17h5"/>',
  trophy:    '<path d="M7 4h10v5a5 5 0 0 1-10 0z"/><path d="M7 6H4a3 3 0 0 0 3 3.5M17 6h3a3 3 0 0 1-3 3.5M10 14h4M9 20h6M12 14v6"/>',
  live:      '<circle cx="12" cy="12" r="2.5"/><path d="M8.2 8.2a5 5 0 0 0 0 7.6M15.8 8.2a5 5 0 0 1 0 7.6M5.4 5.4a9 9 0 0 0 0 13.2M18.6 5.4a9 9 0 0 1 0 13.2"/>',
  flask:     '<path d="M9.5 2v6.5L4 18a2 2 0 0 0 1.8 3h12.4a2 2 0 0 0 1.8-3l-5.5-9.5V2"/><path d="M8 2h8M7 14h10"/>',
  chat:      '<path d="M21 14a2 2 0 0 1-2 2H8l-5 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><path d="M8 9h8M8 12.5h5"/>',
  wave:      '<path d="M2 12h2.5M7 7.5v9M11.5 3.5v17M16 7v10M20.5 10.5v3"/>',
  search:    '<circle cx="11" cy="11" r="7"/><path d="M20.5 20.5L16 16"/>',
  book:      '<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20V2H6.5A2.5 2.5 0 0 0 4 4.5z"/><path d="M4 19.5V22h16M8 7h8M8 11h6"/>',
  keyboard:  '<rect x="2" y="6" width="20" height="12" rx="2"/><path d="M6 10h.01M10 10h.01M14 10h.01M18 10h.01M8 14h8"/>',
  coffee:    '<path d="M4 8h14v6a5 5 0 0 1-5 5H9a5 5 0 0 1-5-5z"/><path d="M18 9.5h1.5a2.5 2.5 0 0 1 0 5H18M7 2v3M11 2v3M15 2v3"/>',
  flame:     '<path d="M12 22a7 7 0 0 0 7-7c0-4-3-6-4.5-9C13 3.5 12 2 12 2s-1 3-3 5.5S5 11 5 15a7 7 0 0 0 7 7z"/>',
  target:    '<circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="5"/><circle cx="12" cy="12" r="1.4"/>',
  spark:     '<path d="M12 3l1.9 5.8L19.5 11l-5.6 2.2L12 19l-1.9-5.8L4.5 11l5.6-2.2z"/>',
  users:     '<circle cx="9" cy="8" r="3.5"/><path d="M2.5 20a6.5 6.5 0 0 1 13 0"/><path d="M17 5.2a3.5 3.5 0 0 1 0 5.6M18.5 20a6.5 6.5 0 0 0-3-5.5"/>',
  rupee:     '<circle cx="12" cy="12" r="9"/><path d="M9 7.5h6M9 10.5h6M13.5 7.5c1.6 0 2.6 1.2 2.6 2.8s-1 2.7-2.6 2.7H9l5 4"/>',
  bee:       '<path d="M12 7c2.8 0 5 2.9 5 6.5S14.8 21 12 21s-5-3.9-5-7.5S9.2 7 12 7z"/><path d="M7.4 11h9.2M7.2 15h9.6M12 3.5v3M9.5 3a2.5 2.5 0 0 0 2.5 3.5A2.5 2.5 0 0 0 14.5 3"/><path d="M6.5 8.5C4 7.5 2.5 8.5 3 10.5M17.5 8.5C20 7.5 21.5 8.5 21 10.5"/>',
};

// Matches a course / feature / lab to its glyph. Order matters: the first
// pattern that fits wins, so put the specific subjects above the general ones.
const ART_RULES = [
  [/tally|gst|ledger|bookkeep|book-keep|account|audit|\btax\b|invoice|billing|payroll|bank/, "receipt"],
  [/excel|spreadsheet|pivot|vlookup/, "grid"],
  [/ms.?office|office suite|office helper/, "grid"],
  [/powerpoint|\bppt\b|slide|present/, "monitor"],
  [/power ?bi|dashboard|analytic|\bdata\b|statistic|report/, "bars"],
  [/\bsql\b|database|mysql/, "database"],
  [/\bjava\b/, "coffee"],
  [/python|\bc\+\+|\bcode|coding|program|script|algorithm|software|firebase|saas|\bapi\b|backend|server|cloud/, "code"],
  [/web|html|css|javascript|react|frontend|full ?stack|website|wordpress|internet|email|browser/, "globe"],
  [/app development|android|flutter|mobile/, "monitor"],
  [/typing|keyboard|shortcut/, "keyboard"],
  [/english|spoken|grammar|communicat|language/, "speech"],
  [/aptitude|reasoning|logic|puzzle|brain|mental/, "brain"],
  [/interview|\bviva\b|\bmic\b|voice|speak|podcast/, "mic"],
  [/resume|\bcv\b|cover letter|portfolio|document|\bword\b|\bpdf\b/, "doc"],
  [/job|career|placement|hiring|recruit|internship/, "briefcase"],
  [/business|entrepreneur|startup|company|office|shop|store|freelanc/, "building"],
  [/market|\bseo\b|\bads?\b|advertis|social media|brand|campaign|sales|lead/, "megaphone"],
  [/video|film|reel|youtube|camera|shoot|edit|content|photo/, "camera"],
  [/design|canva|photoshop|illustrator|figma|graphic|logo|poster|creative|drawing|\bui\b|\bux\b/, "pen"],
  [/lab|practice|experiment|challenge|exercise/, "flask"],
  [/live|class ?room|session|broadcast|stream|meeting/, "live"],
  [/tutor|doubt|\bask\b|question|chat|help|support/, "chat"],
  [/search|explore|find|discover/, "search"],
  [/lesson|course|study|learn|exam|revision|note|syllabus|school|teach|educat|certificate|degree/, "cap"],
  [/reward|trophy|badge|level|point|rank|win|prize|achieve/, "trophy"],
  [/streak|\bfire\b|daily|habit/, "flame"],
  [/goal|target|objective|track|progress/, "target"],
  [/money|rupee|price|salary|fee|finance|invest/, "rupee"],
  [/student|people|team|community|member|user|profile|linkedin|\bcrm\b|customer|client service/, "users"],
  [/computer|\bpc\b|windows|hardware|system|monitor/, "monitor"],
  [/\bai\b|artificial|chatgpt|prompt|machine learning|automat|\bbot\b|\bgpt\b/, "chip"],
];

const artFor = (of) => {
  if (!of) return "bee";
  if (typeof of === "string") return GLYPHS[of] ? of : artKeyFromText(of);
  if (of.art && GLYPHS[of.art]) return of.art;
  return artKeyFromText([of.id, of.key, of.title, of.label, of.name].filter(Boolean).join(" "));
};

const artKeyFromText = (text) => {
  const t = String(text || "").toLowerCase();
  for (const [re, key] of ART_RULES) if (re.test(t)) return key;
  return "bee";
};

// A glyph resting inside a hive cell. `flat` drops the cell for tight spots.
function Art({ of, name, size = 24, color = "var(--blue-600)", flat = false, style }) {
  const key = name && GLYPHS[name] ? name : artFor(of || name);
  const cell = "M24 3.1 42.2 13.6v21L24 45.1 5.8 34.6v-21Z";
  return (
    <svg
      width={size} height={size} viewBox="0 0 48 48" fill="none"
      role="presentation" aria-hidden="true" style={{ display: "block", flexShrink: 0, ...style }}
    >
      {!flat && <path d={cell} fill={color} opacity="0.13" />}
      {!flat && <path d={cell} stroke={color} strokeWidth="1.5" opacity="0.32" />}
      <g
        transform="translate(12 12)"
        stroke={color} strokeWidth="1.9" fill="none"
        strokeLinecap="round" strokeLinejoin="round"
        dangerouslySetInnerHTML={{ __html: GLYPHS[key] }}
      />
    </svg>
  );
}

// A course picture when one is set in PHOTOS, otherwise the hexagon artwork.
function Thumb({ of, size = 44, color = "var(--blue-600)", radius = 12 }) {
  const src = of && (PHOTOS[of.id] || PHOTOS[of.key]);
  if (src) {
    return (
      <img
  ...
  return <Art of={of} size={size} color={color} />;
}
      ...
      <div className="card fade-in" style={{ maxWidth: 420, width: "100%", padding: "40px 36px", textAlign: "center", zIndex: 1 }}>
        ...
        <div style={{ marginBottom: 24 }}>
          <div style={{ width: 100, height: 100, background: "#000", borderRadius: 20, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 14px", boxShadow: "0 8px 24px rgba(0,0,0,0.25)", overflow: "hidden" }}>
            <img src={PHOTOS.logo || LOGO_SRC} alt="Allbee Solutions" style={{ width: 80, height: 80, objectFit: "contain" }} />
          </div>
...
// ─── FEATURE CARD ─────────────────────────────────────────────────────────────
const features = [
  { id: "code", label: "Code Explainer", desc: "Paste code → Get simple explanation", icon: "code", color: "#0d9488", bg: "#eff6ff", },
  { id: "viva", label: "Viva & Exam Prep", desc: "Topic → Important Q&A + revision notes", icon: "book", color: "#7c3aed", bg: "#f5f3ff", },
  { id: "resume", label: "Resume & Projects", desc: "Course → Resume content + project ideas", icon: "file", color: "#059669", bg: "#ecfdf5", },
  { id: "doubt", label: "Doubt Solver", desc: "Ask anything → Clear, simple answer", icon: "help", color: "#d97706", bg: "#fffbeb", },
  { id: "english", label: "Spoken English", desc: "Practice sentences & grammar tips", icon: "mic", color: "#dc2626", bg: "#fef2f2", },
  { id: "msoffice", label: "MS Office Helper", desc: "Word, Excel & PowerPoint guide", icon: "office", color: "#0f4c81", bg: "#e8f0fe", },
];

const officeApps = [
  { id: "word",  label: "MS Word", color: "#185abd", bg: "#e8f0fe",
  ...
  { id: "excel", label: "MS Excel", color: "#1d6f42", bg: "#e6f4ea",
  ...
  { id: "ppt",   label: "PowerPoint", color: "#c43e1c", bg: "#fce8e6",
...
const CATEGORIES = [
  {
    ...
    courses: [
      { id: "ai-for-beginners", title: "AI for Beginners", topics: ["What is AI & How It Works", "Everyday AI Tools You Can Use", "Writing Good AI Prompts", "AI for Studies & Work", "AI Safety & Smart Use"] },
      { id: "chatgpt-mastery", title: "ChatGPT Mastery", topics: ["ChatGPT Basics & Setup", "Prompting Like a Pro", "ChatGPT for Writing & Email", "ChatGPT for Study & Coding", "Custom GPTs & Advanced Tricks"] },
      { id: "prompt-engineering", title: "Prompt Engineering", topics: ["What is a Prompt", "Prompt Structure & Roles", "Few-shot & Examples", "Step-by-Step Reasoning Prompts", "Prompts for Images & Code"] },
      { id: "ai-tools-for-students", title: "AI Tools for Students", topics: ["AI Note-taking & Summaries", "AI for Assignments (the right way)", "AI Research Helpers", "AI for Exam Prep", "Best Free AI Tools"] },
      { id: "ai-tools-for-business-owners", title: "AI Tools for Business Owners", topics: ["AI for Customer Replies", "AI for Social Media Posts", "AI for Sales & Leads", "AI Data & Reports", "Saving Time with AI"] },
      { id: "ai-content-creation", title: "AI Content Creation", topics: ["AI Blog & Article Writing", "AI Captions & Hashtags", "AI Scripts for Videos", "Repurposing Content with AI", "Editing AI Content Well"] },
      { id: "ai-image-generation", title: "AI Image Generation", topics: ["Intro to AI Image Tools", "Writing Image Prompts", "Midjourney Basics", "Leonardo AI Basics", "Editing & Upscaling Images"] },
      { id: "ai-video-creation", title: "AI Video Creation", topics: ["AI Video Tools Overview", "Text-to-Video Basics", "AI Avatars & Talking Heads", "AI Voiceovers for Video", "Editing AI Videos"] },
      { id: "ai-voice-generation", title: "AI Voice Generation", topics: ["What is AI Voice", "Text-to-Speech Tools", "Cloning & Custom Voices", "Voiceovers for Reels/YouTube", "Voice in Tamil & English"] },
      { id: "aitools", title: "AI Automation (No Code)", tag: "Future Skills", level: "No coding needed", duration: "3–4 Weeks", bestFor: "Entrepreneurs & Professionals", outcome: "Automate tasks & 10x your productivity", topics: ["ChatGPT for Productivity", "AI Tools for Business", "Automation Basics", "Workflow Automation (n8n)"] },
      { id: "ai-for-digital-marketing", title: "AI for Digital Marketing", topics: ["AI for Ad Copy", "AI for SEO Content", "AI Social Media Planning", "AI Image & Creative Ads", "AI Analytics Insights"] },
      { id: "ai-for-teachers", title: "AI for Teachers", topics: ["AI Lesson Planning", "AI Question Paper Maker", "AI for Grading Help", "AI Teaching Materials", "Explaining Topics with AI"] },
      { id: "ai-for-accountants", title: "AI for Accountants", topics: ["AI for Data Entry", "AI Excel Formula Helper", "AI for GST/Tax Queries", "AI Report Writing", "AI Bookkeeping Tools"] },
      { id: "ai-for-freelancers", title: "AI for Freelancers", topics: ["AI for Proposals & Pitches", "AI Client Communication", "AI to Deliver Work Faster", "AI Portfolio & Branding", "Pricing Your AI Skills"] },
    ],
  },
  {
    ...
    courses: [
      { id: "computer-basics", title: "Computer Basics", topics: ["Parts of a Computer", "Using Windows & Files", "Keyboard & Mouse Skills", "Internet & Browsers", "Staying Safe Online"] },
      { id: "ms-office-complete", title: "MS Office Complete", topics: ["MS Word Essentials", "MS Excel Essentials", "MS PowerPoint Essentials", "Working Between Office Apps", "Printing & Saving as PDF"] },
      { id: "excel", title: "Advanced Excel", tag: "Most Popular", level: "Beginner → Advanced", duration: "4–6 Weeks", bestFor: "Students, Office Staff, Accountants, Data Entry Jobs", outcome: "Job-ready Excel skills for data & office work", topics: ["Excel Basics to Advanced", "Formulas & Functions", "Pivot Tables", "Dashboards", "Data Cleaning", "Excel Automation Tips", "Real-world Business Reports"] },
      { id: "powerpoint-mastery", title: "PowerPoint Mastery", topics: ["Slide Design Basics", "Themes & Layouts", "Animations & Transitions", "Charts & SmartArt", "Presenting with Confidence"] },
      { id: "internet-email-skills", title: "Internet & Email Skills", topics: ["Browsing & Searching Well", "Creating & Using Email", "Attachments & Drive", "Online Safety & Passwords", "Video Calls & Meetings"] },
      { id: "typing-tamil-english", title: "Typing (Tamil & English)", topics: ["Home Row & Posture", "English Touch Typing", "Tamil Typing Basics", "Speed Building Drills", "Accuracy & Shortcuts"] },
      { id: "powerbi", title: "Power BI", tag: "High Demand", level: "Intermediate", duration: "4–5 Weeks", bestFor: "Data Analysts & Business Reporting", outcome: "Create stunning business dashboards", topics: ["Data Import & Transformation", "Data Modeling", "DAX Basics", "Interactive Dashboards", "Business Reports"] },
    ],
  },
  {
    ...
    courses: [
      { id: "tally-prime", title: "Tally Prime", topics: ["Tally Setup & Company Creation", "Ledgers & Groups", "Voucher Entry", "GST in Tally", "Reports & Balance Sheet"] },
      { id: "gst-filing", title: "GST Filing", topics: ["GST Basics & Types", "GST Registration", "Invoices & Returns", "GSTR-1 & GSTR-3B Filing", "Input Tax Credit"] },
      { id: "income-tax-basics", title: "Income Tax Basics", topics: ["Income Tax Overview", "Tax Slabs & Heads of Income", "Deductions (80C etc.)", "Filing ITR Online", "Form 16 & TDS"] },
      { id: "payroll-management", title: "Payroll Management", topics: ["Salary Components", "PF, ESI & Deductions", "Payslip Preparation", "Payroll in Excel/Tally", "Compliance Basics"] },
      { id: "accounting-fundamentals", title: "Accounting Fundamentals", topics: ["What is Accounting", "Debit & Credit Rules", "Journal & Ledger", "Trial Balance", "Final Accounts"] },
      { id: "business-accounting", title: "Business Accounting", topics: ["Recording Business Transactions", "Cash vs Bank Book", "Profit & Loss Account", "Balance Sheet Basics", "Day-to-day Bookkeeping"] },
    ],
  },
  {
    ...
    courses: [
      { id: "python", title: "Python", tag: "Beginner Friendly", level: "Complete Beginner", duration: "6–8 Weeks", bestFor: "Beginners who want to enter programming or automation", outcome: "Build real automation scripts & small projects", topics: ["Python Basics", "Variables, Loops, Functions", "File Handling", "Error Handling", "Working with APIs & JSON", "Basic Automation Projects"] },
      { id: "java", title: "Java", topics: ["Java Setup & First Program", "Variables & Data Types", "Loops & Conditions", "Methods & OOP Basics", "Classes & Objects"] },
      { id: "javascript", title: "JavaScript", topics: ["JS Basics & Syntax", "Variables & Functions", "DOM & Events", "Arrays & Objects", "Async & Fetch"] },
      { id: "c-programming", title: "C Programming", topics: ["C Setup & First Program", "Variables & Operators", "Loops & Conditions", "Functions & Arrays", "Pointers Basics"] },
      { id: "c", title: "C++", topics: ["C++ Basics", "Loops & Functions", "OOP: Classes & Objects", "Inheritance & Polymorphism", "STL Basics"] },
      { id: "webdev", title: "Web Development", tag: "Freelance Ready", level: "Beginner", duration: "6–8 Weeks", bestFor: "Students who want to start in tech or freelance", outcome: "Launch your own website & start freelancing", topics: ["HTML Basics", "CSS & Styling", "Basic JavaScript", "Build Portfolio Website", "GitHub Hosting"] },
      { id: "full-stack-development", title: "Full Stack Development", topics: ["Frontend vs Backend", "HTML, CSS, JS Refresher", "Node.js & Express Basics", "Databases Basics", "Connecting Front & Back"] },
      { id: "react-js", title: "React JS", topics: ["React Setup & JSX", "Components & Props", "State & Hooks", "Handling Events & Forms", "Fetching Data & Routing"] },
      { id: "firebase-development", title: "Firebase Development", topics: ["What is Firebase", "Authentication", "Firestore Database", "Hosting Your App", "Realtime Data & Rules"] },
    ],
  },
  {
    ...
    courses: [
      { id: "website-design", title: "Website Design", topics: ["Design Principles", "Layout & Spacing", "Colors & Typography", "Responsive Design", "Design Tools (Figma)"] },
      { id: "wordpress-development", title: "WordPress Development", topics: ["WordPress Setup", "Themes & Customizing", "Pages, Posts & Menus", "Plugins You Need", "Going Live"] },
      { id: "e-commerce-website", title: "E-Commerce Website", topics: ["Plan Your Online Store", "Products & Categories", "Cart & Checkout", "Payment Gateways", "Launch & Promote"] },
      { id: "progressive-web-apps", title: "Progressive Web Apps", topics: ["What is a PWA", "Manifest & Icons", "Service Workers", "Offline Support", "Installable Apps"] },
      { id: "mobile-app-development", title: "Mobile App Development", topics: ["App Basics & Tools", "UI Screens & Navigation", "Buttons, Inputs & Lists", "Storing Data", "Publishing Your App"] },
      { id: "saas-development", title: "SaaS Development", topics: ["What is SaaS", "Planning Your SaaS", "User Accounts & Plans", "Subscriptions & Payments", "Launching to Users"] },
    ],
  },
  {
    ...
    courses: [
      { id: "canva-design-mastery", title: "Canva Design Mastery", topics: ["Canva Basics", "Posters & Social Posts", "Templates & Brand Kit", "Logos & Thumbnails", "Presentations & Videos"] },
      { id: "graphic-design", title: "Graphic Design", topics: ["Design Principles", "Color Theory", "Typography Basics", "Composition & Layout", "Building a Portfolio"] },
      { id: "photoshop", title: "Photoshop", topics: ["Photoshop Interface", "Layers & Selections", "Photo Editing & Retouch", "Text & Effects", "Exporting for Web/Print"] },
      { id: "illustrator", title: "Illustrator", topics: ["Illustrator Basics", "Shapes & Pen Tool", "Working with Color", "Logos & Icons", "Vector Illustrations"] },
      { id: "ui-ux-design", title: "UI/UX Design", topics: ["UX vs UI", "User Research Basics", "Wireframing", "UI Design in Figma", "Prototyping & Testing"] },
      { id: "logo-design", title: "Logo Design", topics: ["Logo Types & Ideas", "Sketching Concepts", "Color & Font Choices", "Designing in Canva/Illustrator", "Delivering to Clients"] },
    ],
  },
  {
    ...
    courses: [
      { id: "seo", title: "SEO", topics: ["What is SEO", "Keyword Research", "On-Page SEO", "Backlinks & Off-Page", "Tracking with Analytics"] },
      { id: "social-media-marketing", title: "Social Media Marketing", topics: ["Choosing the Right Platforms", "Content Planning", "Growing Followers", "Engagement Strategy", "Measuring Results"] },
      { id: "facebook-ads", title: "Facebook Ads", topics: ["Ads Manager Basics", "Audience Targeting", "Creating an Ad", "Budget & Bidding", "Reading Ad Results"] },
      { id: "google-ads", title: "Google Ads", topics: ["Google Ads Overview", "Keywords & Match Types", "Writing Search Ads", "Budget & Bidding", "Conversion Tracking"] },
      { id: "content-marketing", title: "Content Marketing", topics: ["Content Strategy", "Blogging & SEO", "Email Marketing", "Lead Magnets", "Measuring Content ROI"] },
      { id: "affiliate-marketing", title: "Affiliate Marketing", topics: ["What is Affiliate Marketing", "Choosing Products & Niches", "Building a Platform", "Driving Traffic", "Tracking Commissions"] },
    ],
  },
  {
    ...
    courses: [
      ...
      { id: "video-recording", title: "Video Recording", topics: ["Camera & Phone Setup", "Lighting Basics", "Recording Clear Audio", "Framing & Composition", "Recording B-Roll & Screen"] },
      { id: "video-editing", title: "Video Editing", topics: ["Editing Basics", "Cuts & Transitions", "Adding Text & Music", "Color & Audio Fixes", "Exporting for Platforms"] },
      { id: "thumbnail-design", title: "Thumbnail Design", topics: ["Why Thumbnails Matter", "Design in Canva", "Text & Contrast", "Faces & Emotions", "A/B Testing Ideas"] },
      { id: "podcast-creation", title: "Podcast Creation", topics: ["Planning Your Podcast", "Recording Gear & Apps", "Recording & Editing", "Publishing to Platforms", "Growing Your Audience"] },
      { id: "personal-branding", title: "Personal Branding", topics: ["What is a Personal Brand", "Finding Your Niche", "Profile & Bio Setup", "Content That Builds Trust", "Growing Your Audience"] },
    ],
  },
  {
    ...
    courses: [
      { id: "resume-building", title: "Resume Building", topics: ["Resume Structure", "Writing a Strong Objective", "Skills & Projects Section", "Formatting & ATS Tips", "Common Mistakes"] },
      { id: "interview-preparation", title: "Interview Preparation", topics: ["Before the Interview", "Common HR Questions", "Technical Round Tips", "Body Language & Confidence", "Follow-up & Thank You"] },
      { id: "linkedin-optimization", title: "LinkedIn Optimization", topics: ["Profile Photo & Headline", "About & Experience", "Skills & Endorsements", "Networking & Posts", "Finding Jobs on LinkedIn"] },
      { id: "freelancing-mastery", title: "Freelancing Mastery", topics: ["Choosing Your Skill", "Profiles on Upwork/Fiverr", "Winning Proposals", "Pricing & Payments", "Getting 5-Star Reviews"] },
      { id: "remote-job-skills", title: "Remote Job Skills", topics: ["Finding Remote Jobs", "Tools for Remote Work", "Communication & Time Zones", "Productivity at Home", "Standing Out Remotely"] },
      { id: "business-communication", title: "Business Communication", topics: ["Professional Emails", "Meeting Etiquette", "Clear Speaking & Listening", "Reports & Presentations", "Workplace Confidence"] },
      { id: "portfolio", title: "Portfolio & Career Setup", tag: "Job Focused", level: "All Levels", duration: "2–3 Weeks", bestFor: "Students looking for IT jobs / Remote jobs", outcome: "Land your first IT job or remote opportunity", topics: ["Build Personal Portfolio Website", "GitHub Setup", "Resume Building", "Job Application Guidance"] },
    ],
  },
  {
    ...
    courses: [
      { id: "entrepreneurship", title: "Entrepreneurship", topics: ["Idea to Business", "Validating Your Idea", "Business Model Basics", "Funding & Costs", "Launching Your Startup"] },
      { id: "small-business-management", title: "Small Business Management", topics: ["Setting Up a Business", "Managing Money", "Hiring & Team", "Operations & Systems", "Growth Planning"] },
      { id: "sales-marketing", title: "Sales & Marketing", topics: ["Understanding Customers", "Sales Funnel Basics", "Pitching & Closing", "Marketing Channels", "Retaining Customers"] },
      { id: "customer-service", title: "Customer Service", topics: ["Customer Service Basics", "Handling Complaints", "Communication Skills", "Building Loyalty", "Service via Phone/Chat"] },
      { id: "crm-management", title: "CRM Management", topics: ["What is a CRM", "Managing Contacts & Leads", "Sales Pipeline", "Follow-ups & Automation", "Reports & Insights"] },
    ],
  },
  {
    id: "special", name: "Special AllBee Programs",
    ...
    courses: [
      { id: "ai-excel-expert", title: "AI + Excel Expert", topics: ["Excel Foundations", "AI Formula Assistant", "Automating Reports with AI", "AI Data Analysis", "Job-Ready Excel + AI"] },
      { id: "ai-tally-professional", title: "AI + Tally Professional", topics: ["Tally Foundations", "AI for Accounting Queries", "GST & Tax with AI Help", "AI Report Insights", "Accountant + AI Workflow"] },
      { id: "ai-digital-marketing", title: "AI + Digital Marketing", topics: ["Marketing Foundations", "AI Content & Ads", "AI SEO Strategy", "AI Social Media Planning", "Full AI Marketing Workflow"] },
      { id: "ai-web-development", title: "AI + Web Development", topics: ["Web Dev Foundations", "AI Coding Assistants", "Building Sites Faster with AI", "AI for Design & Content", "Deploy & Launch"] },
      { id: "ai-business-automation", title: "AI + Business Automation", topics: ["Business Process Basics", "No-Code Automation", "AI Chatbots & Replies", "Connecting Your Tools", "Scaling with Automation"] },
      { id: "ai-entrepreneur-program", title: "AI Entrepreneur Program", topics: ["AI Business Ideas", "Building an AI Product/Service", "AI Tools to Run a Business", "Marketing with AI", "Launch & Grow"] },
    ],
  },
];
    ...
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "0 16px 100px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 14, marginBottom: 28 }}>
        <button onClick={() => onOpen("tutor")} className="card-hover" style={{ textAlign: "left", cursor: "pointer", border: "none", borderRadius: "var(--radius-xl)", padding: "20px 22px", color: "white", background: "linear-gradient(135deg,#4338ca 0%,#6366f1 100%)", position: "relative", overflow: "hidden" }}>
          <div style={{ position: "absolute", right: -10, top: -10, fontSize: 78, opacity: 0.16 }}><Art name="chat" size={78} color="#ffffff" flat /></div>
          <div style={{ fontSize: 30, marginBottom: 10 }}><Art name="chat" size={30} color="#ffffff" flat /></div>
        ...
        <button onClick={() => onOpen("voice")} className="card-hover" style={{ textAlign: "left", cursor: "pointer", border: "none", borderRadius: "var(--radius-xl)", padding: "20px 22px", color: "white", background: "linear-gradient(135deg,#0e7490 0%,#06b6d4 100%)", position: "relative", overflow: "hidden" }}>
          <div style={{ position: "absolute", right: -10, top: -10, fontSize: 78, opacity: 0.16 }}><Art name="mic" size={78} color="#ffffff" flat /></div>
          <div style={{ fontSize: 30, marginBottom: 10 }}><Art name="mic" size={30} color="#ffffff" flat /></div>
        ...
        {features.map((f, i) => (
          ...
          >
            <div style={{ width: 44, height: 44, background: f.bg, borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, marginBottom: 14 }}>
              <Art of={f} size={26} color={f.color} flat />
            </div>
      ...
      <div onClick={onCourses} style={{ background: "linear-gradient(135deg, #0f172a 0%, #134e4a 60%, #0f766e 100%)", borderRadius: "var(--radius-xl)", padding: "22px 24px", marginBottom: 16, cursor: "pointer", position: "relative", overflow: "hidden", border: "1px solid #115e59" }}>
        <div style={{ position: "absolute", right: -30, bottom: -30, fontSize: 120, opacity: 0.07, pointerEvents: "none" }}><Art name="bee" size={120} color="#ffffff" flat /></div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14, background: "white", border: "1.5px solid var(--blue-200)", borderRadius: "var(--radius-lg)", padding: "16px 18px", marginBottom: 32, flexWrap: "wrap" }}>
        <div style={{ width: 44, height: 44, background: "var(--blue-50)", borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, flexShrink: 0 }}><Art name="cap" size={26} flat /></div>
            ...
            {hist.slice(0, 3).map(h => {
              ...
              return (
                <div key={h.id} className="card" style={{ padding: "12px 16px", display: "flex", alignItems: "center", gap: 12 }}>
                  <Art of={feat} size={22} color={feat?.color} flat />
  ...
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: "0 16px 100px" }}>
      ...
      <div style={{ paddingTop: 20, paddingBottom: 16, display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <div style={{ width: 40, height: 40, background: "#e8f0fe", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20 }}><Art name="grid" size={24} color="#0f4c81" flat /></div>
        <div>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 18 }}>
        {officeApps.map(a => (
          <button key={a.id} onClick={() => switchApp(a.id)} style={{ flex: 1, padding: "10px 8px", borderRadius: "var(--radius)", border: "2px solid", cursor: "pointer", transition: "all 0.2s", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: 13, display: "flex", flexDirection: "column", alignItems: "center", gap: 4,
            ...
            <span style={{ fontSize: 20 }}><Art of={a} size={20} color={a.color} flat /></span>
      ...
      {loading && (
        <div className="card fade-in" style={{ padding: 28, textAlign: "center" }}>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }}>
            <div style={{ fontSize: 36, animation: "pulse 1.5s infinite" }}><Art of={app} size={40} color={app.color} /></div>
  ...
  return (
    <div style={{ maxWidth: 760, margin: "0 auto", padding: "0 16px 100px" }}>
      ...
      <div style={{ paddingTop: 20, paddingBottom: 20, display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <div style={{ width: 40, height: 40, background: feat.bg, borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20 }}><Art of={feat} size={22} color={feat.color} flat /></div>
        <div>
  ...
  return (
    <div style={{ maxWidth: 760, margin: "0 auto", padding: "0 16px 100px" }}>
      ...
      <div style={{ display: "flex", gap: 8, overflowX: "auto", paddingBottom: 8, marginBottom: 16, scrollbarWidth: "none" }}>
        {[{ id: "all", label: "All" }, ...features.map(f => ({ id: f.id, label: f.label.split(" ")[0] }))].map(tab => (
      ...
      {filtered.length === 0 ? (
        <div className="card" style={{ padding: 48, textAlign: "center" }}>
          <div style={{ display: "flex", justifyContent: "center", marginBottom: 16 }}><Art name="search" size={48} color="var(--slate-300)" /></div>
            ...
            return (
              <div key={h.id} className="card slide-in" style={{ overflow: "hidden" }}>
                <div style={{ padding: "14px 16px", display: "flex", alignItems: "center", gap: 12, cursor: "pointer" }} onClick={() => setExpanded(isExp ? null : h.id)}>
                  <div style={{ width: 36, height: 36, background: feat?.bg || "var(--slate-100)", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, flexShrink: 0 }}><Art of={feat} size={20} color={feat?.color} flat /></div>
                  <div style={{ flex: 1, minWidth: 0 }}>
    ...
    return (
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "0 16px 100px" }}>
        ...
        <div style={{ background: c.gradient, borderRadius: "var(--radius-xl)", padding: "22px 24px", marginBottom: 20, color: "white", position: "relative", overflow: "hidden" }} className="fade-in">
          <div style={{ position: "absolute", right: -16, top: -16, fontSize: 90, opacity: 0.12, pointerEvents: "none" }}><Art of={c} size={90} color="#ffffff" flat /></div>
        ...
        {teacherNote && (
          <div className="card fade-in" style={{ padding: "16px 18px", marginBottom: 16, background: "#fffdf5", border: "1.5px solid #fde68a", borderLeft: "4px solid #f59e0b" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
              <span style={{ fontSize: 18 }}><Art name="doc" size={18} color="#0d9488" flat /></span>
    ...
    return (
      <div style={{ maxWidth: 700, margin: "0 auto", padding: "0 16px 100px" }}>
        ...
        <div style={{ background: c.gradient, borderRadius: "var(--radius-xl)", padding: "28px 26px 24px", marginBottom: 20, position: "relative", overflow: "hidden", color: "white" }} className="fade-in">
          <div style={{ position: "absolute", right: -20, top: -20, fontSize: 100, opacity: 0.12, pointerEvents: "none" }}><Art of={c} size={100} color="#ffffff" flat /></div>
  ...
  return (
    <div style={{ maxWidth: 980, margin: "0 auto", padding: "0 16px 100px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14, background: "white", border: "1.5px solid var(--blue-200)", borderRadius: "var(--radius-lg)", padding: "14px 16px", marginBottom: 20, flexWrap: "wrap" }}>
        <div style={{ width: 42, height: 42, background: "var(--blue-50)", borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 21, flexShrink: 0 }}><Art name="cap" size={26} flat /></div>
      ...
      <div style={{ position: "relative", marginBottom: 16 }}>
        <span style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", fontSize: 16, pointerEvents: "none" }}><Art name="search" size={17} color="var(--slate-400)" flat /></span>
        <input
          value={query}
      ...
      {!q && catFilter === "all" && (
        <div style={{ marginBottom: 30 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
            <div style={{ width: 36, height: 36, borderRadius: 10, background: "linear-gradient(135deg,#d97706,#f59e0b)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, flexShrink: 0 }}><Art name="spark" size={22} color="#ffffff" flat /></div>
            <div style={{ flex: 1 }}>
            ...
            {FEATURED_COURSES.map((c, i) => (
              <button key={c.id} onClick={() => { setSelected(c.id); window.scrollTo({ top: 0, behavior: "smooth" }); }} className="card card-hover" style={{ padding: 0, textAlign: "left", border: "1.5px solid #fde68a", animation: `fadeIn 0.35s ease ${Math.min(i * 0.05, 0.4)}s both`, cursor: "pointer", overflow: "hidden", background: "white" }}>
                <div style={{ background: c.gradient, padding: "16px 18px 14px", position: "relative", overflow: "hidden" }}>
                  <div style={{ position: "absolute", right: -10, top: -10, fontSize: 56, opacity: 0.15, pointerEvents: "none" }}><Art of={c} size={56} color={cat.color} flat /></div>
                  <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 8 }}>
                    <div style={{ fontSize: 26 }}><Thumb of={c} size={30} color={cat.color} /></div>
      ...
      {visibleCats.length === 0 ? (
        <div className="card" style={{ padding: "32px 20px", textAlign: "center", color: "var(--slate-500)" }}>
          <div style={{ display: "flex", justifyContent: "center", marginBottom: 8 }}><Art name="search" size={34} color="var(--slate-300)" /></div>
        ...
        visibleCats.map(({ cat, items }) => (
          <div key={cat.id} style={{ marginBottom: 32 }}>
            {/* Category header */}
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
              <div style={{ width: 36, height: 36, borderRadius: 10, background: cat.gradient, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, flexShrink: 0 }}><Art of={cat} size={22} color="#ffffff" flat /></div>
              <div style={{ flex: 1 }}>
...
function ScreenHeader({ art, of, color = "var(--blue-600)", title, subtitle, onBack }) {
  return (
    <div style={{ paddingTop: 20, paddingBottom: 16, display: "flex", alignItems: "center", gap: 14 }}>
      ...
      <Art name={art} of={of} size={44} color={color} />
...
function DashboardBee({ onOpen }) {
  ...
  return (
    <div onClick={() => onOpen && onOpen("rewards")} className="card-hover" style={{ cursor: "pointer", background: "linear-gradient(135deg, #115e59 0%, #0d9488 55%, #14b8a6 100%)", borderRadius: "var(--radius-xl)", padding: "18px 20px", marginBottom: 16, color: "white", position: "relative", overflow: "hidden" }}>
      <div style={{ position: "absolute", right: -14, top: -14, fontSize: 96, opacity: 0.16 }}><Art of={lvl.current} size={96} color="#ffffff" flat /></div>
      <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 12, position: "relative" }}>
        <div style={{ width: 48, height: 48, background: "rgba(255,255,255,0.16)", borderRadius: 14, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 26 }}><Art of={lvl.current} size={30} color="#ffffff" flat /></div>
        <div style={{ flex: 1, minWidth: 0 }}>
      ...
      <div style={{ position: "relative" }}>
        ...
        <div style={{ fontSize: 11, opacity: 0.85, marginTop: 6 }}>
          {lvl.next ? `${lvl.next.min - points} pts to ${lvl.next.name}` : "Max level reached — you're a legend!"}
        </div>
      </div>
    </div>
  );
...
function DashboardStats() {
  const p = getProgress();
  const cards = [
    { label: "AI Questions", value: getHistory().length, color: "var(--blue-600)" },
    { label: "Lessons Read", value: p.lessonsRead, color: "#0d9488" },
    { label: "Day Streak", value: getStreak().count, color: "#d97706" },
    { label: "Best Interview", value: bestInterviewScore() + "%", color: "#7c3aed" },
    { label: "Labs Solved", value: p.labsDone, color: "#0891b2" },
    { label: "Jobs Applied", value: p.jobsApplied, color: "#059669" },
    { label: "Certificates", value: p.certificates, color: "#a855f7" },
  ];
  return (
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(148px, 1fr))", gap: 12, marginBottom: 24 }}>
        {cards.map((c, i) => (
          <div key={c.label} className="card" style={{ padding: "16px 16px 15px", animation: `fadeIn 0.4s ease ${i * 0.05}s both` }}>
            <div style={{ width: 34, height: 34, borderRadius: 9, background: c.color + "14", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 17, marginBottom: 12 }}><Art of={c} size={20} color={c.color} flat /></div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 12 }}>
        {skills.map(s => (
          <div key={s.key} style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ fontSize: 17, width: 24, textAlign: "center", flexShrink: 0 }}><Art of={s} size={20} /></div>
...
const CAREER_MODULES = [
  { id: "live", label: "Live Class",           desc: "Join your teacher's live online class + Q&A", color: "#dc2626", bg: "#fef2f2" },
  { id: "resume_builder", label: "Resume Builder",       desc: "Templates, ATS review, cover letter & export", color: "#0d9488", bg: "#f0fdfa" },
  { id: "interview", label: "AI Mock Interview",    desc: "Role questions, voice, scoring & report",      color: "#7c3aed", bg: "#f5f3ff" },
  { id: "labs", label: "AI Practice Labs",     desc: "9 topics · 100+ questions each with AI feedback", color: "#0891b2", bg: "#ecfeff" },
  { id: "jobs", label: "Job Portal",           desc: "Search, apply, save & track jobs",             color: "#d97706", bg: "#fffbeb" },
  { id: "rewards", label: "Rewards & Bee Levels", desc: "Points, streak, leaderboard & certificates",   color: "#a855f7", bg: "#faf5ff" },
];
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(250px, 1fr))", gap: 16, marginBottom: 32 }}>
        {CAREER_MODULES.map((m, i) => (
          <button key={m.id} onClick={() => onOpen(m.id)} className="card card-hover" style={{ padding: "22px 20px", textAlign: "left", cursor: "pointer", background: "white", animation: `fadeIn 0.4s ease ${i * 0.06}s both` }}>
            <div style={{ width: 44, height: 44, background: m.bg, borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, marginBottom: 14 }}><Art of={m} size={26} color={m.color} flat /></div>
...
// ═══════════════════════════════════════════════════════════════════════════
const POINT_RULES = [
  { label: "Ask the AI tutor a question", pts: "+10" },
  { label: "Read a course lesson",        pts: "+15" },
  { label: "Solve a practice challenge",  pts: "+20" },
  { label: "Build / export a resume",     pts: "+25" },
  { label: "Finish a mock interview",     pts: "+30" },
  { label: "Apply to a job",              pts: "+15" },
  { label: "Earn a certificate",          pts: "+50" },
];
...
function RewardsScreen({ user, onBack }) {
  ...
  const badges = [
    { got: getHistory().length >= 1, label: "First Step", desc: "Asked your first question" },
    { got: streak.count >= 3, label: "On Fire", desc: "3-day streak" },
    { got: streak.count >= 7, label: "Unstoppable", desc: "7-day streak" },
    { got: p.interviews >= 1, label: "Interviewed", desc: "Completed a mock interview" },
    { got: best >= 80, label: "Interview Ace", desc: "Scored 80+ in an interview" },
    { got: p.labsDone >= 3, label: "Lab Rat", desc: "Solved 3 practice challenges" },
    { got: p.resumes >= 1, label: "Job Ready", desc: "Built a resume" },
    { got: p.jobsApplied >= 1, label: "Applicant", desc: "Applied to a job" },
  ];
  const earned = badges.filter(b => b.got).length;

  return (
    <div style={PAGE}>
      <ScreenHeader art="trophy" color="#a855f7" title="Rewards & Bee Levels" subtitle="Points · streak · leaderboard" onBack={onBack} />
      ...
      <div style={{ background: "linear-gradient(135deg, #115e59 0%, #0d9488 55%, #14b8a6 100%)", borderRadius: "var(--radius-xl)", padding: "22px 24px", color: "white", marginBottom: 18, position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", right: -18, top: -18, fontSize: 130, opacity: 0.15 }}><Art of={lvl.current} size={130} color="#ffffff" flat /></div>
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 14, position: "relative" }}>
          <div style={{ width: 60, height: 60, background: "rgba(255,255,255,0.16)", borderRadius: 18, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 34 }}><Art of={lvl.current} size={38} color="#ffffff" flat /></div>
          <div>
        ...
        <div style={{ fontSize: 12, opacity: 0.9, marginTop: 8 }}>{lvl.next ? `${lvl.next.min - points} points to ${lvl.next.name}` : "Max level — Queen Bee!"}</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(150px, 1fr))", gap: 12, marginBottom: 26 }}>
        {badges.map(b => (
          <div key={b.label} className="card" style={{ padding: "14px 14px", textAlign: "center", opacity: b.got ? 1 : 0.5, filter: b.got ? "none" : "grayscale(0.7)", border: b.got ? "1.5px solid var(--blue-200)" : "1px solid var(--slate-200)" }}>
            <div style={{ fontSize: 30, marginBottom: 6 }}><Art of={b} size={30} color={b.got ? "#d97706" : "var(--slate-300)"} /></div>
      ...
      <div className="card" style={{ padding: "8px 6px", marginBottom: 10 }}>
        {POINT_RULES.map(r => (
          <div key={r.label} style={{ display: "flex", alignItems: "center", gap: 12, padding: "10px 14px" }}>
            <div style={{ fontSize: 19 }}><Art of={r} size={20} /></div>
...
function ResumeBuilderScreen({ user, onBack }) {
  ...
  return (
    <div style={PAGE}>
      <ScreenHeader art="doc" color="#0d9488" title="Resume Builder" subtitle="ATS-friendly · AI-reviewed · export PDF/Word" onBack={onBack} />
...
const INTERVIEW_ROLES = [
  { id: "Python Developer", bg: "#f0fdfa" },
  { id: "Web Developer", bg: "#eef2ff" },
  { id: "Java Developer", bg: "#fff7ed" },
  { id: "React Developer", bg: "#ecfeff" },
  { id: "Data Analyst", bg: "#eff6ff" },
  { id: "Power BI Developer", bg: "#e0f2fe" },
  { id: "Accountant", bg: "#f0fdf4" },
  { id: "Tally / GST Accountant", bg: "#fefce8" },
  { id: "Office Executive", bg: "#fff7ed" },
  { id: "Data Entry Operator", bg: "#f1f5f9" },
  { id: "Digital Marketing", bg: "#faf5ff" },
  { id: "SEO Specialist", bg: "#f5f3ff" },
  { id: "Graphic Designer", bg: "#fdf2f8" },
  { id: "Video Editor", bg: "#fef2f2" },
  { id: "Content Writer", bg: "#f0fdfa" },
  { id: "Sales Executive", bg: "#fffbeb" },
  { id: "HR Executive", bg: "#eff6ff" },
  { id: "Customer Support", bg: "#fef2f2" },
];
...
function InterviewScreen({ onBack }) {
  ...
  if (stage === "pick") {
    return (
      <div style={PAGE}>
        <ScreenHeader art="mic" color="#7c3aed" title="AI Mock Interview" subtitle="Pick a role — AI will interview & score you" onBack={onBack} />
        <div className="card" style={{ padding: "16px 18px", marginBottom: 18, display: "flex", gap: 12, alignItems: "center", background: "linear-gradient(135deg,#faf5ff,#ffffff)" }}>
          <Art name="mic" size={30} color="#7c3aed" />
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: 14 }}>
          {INTERVIEW_ROLES.map((r, i) => (
            <button key={r.id} onClick={() => start(r.id)} className="card card-hover" style={{ padding: "20px 18px", textAlign: "left", cursor: "pointer", background: "white", animation: `fadeIn 0.4s ease ${i * 0.05}s both` }}>
              <div style={{ width: 44, height: 44, background: r.bg, borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, marginBottom: 12 }}><Art of={r} size={26} color="#7c3aed" flat /></div>
  ...
  if (stage === "result" && result) {
    ...
    return (
      <div style={PAGE}>
        <ScreenHeader art="target" color="#7c3aed" title="Interview Result" subtitle={role} onBack={onBack} />
  ...
  return (
    <div style={PAGE}>
      <ScreenHeader art="mic" color="#7c3aed" title="Mock Interview" subtitle={role} onBack={() => setStage("pick")} />
...
const LABS = [
  {
    id: "python", label: "Python Lab", color: "#0d9488", bg: "#f0fdfa", mono: true, voice: false,
  ...
  {
    id: "excel", label: "Excel Lab", color: "#1d6f42", bg: "#e6f4ea", mono: true, voice: false,
  ...
  {
    id: "tally", label: "Tally & GST Lab", color: "#b45309", bg: "#fff7ed", mono: false, voice: false,
  ...
  {
    id: "english", label: "Spoken English Lab", color: "#dc2626", bg: "#fef2f2", mono: false, voice: true,
  ...
  {
    id: "sql", label: "SQL Lab", color: "#4f46e5", bg: "#eef2ff", mono: true, voice: false,
  ...
  {
    id: "webjs", label: "Web / JavaScript Lab", color: "#7c3aed", bg: "#f5f3ff", mono: true, voice: false,
  ...
  {
    id: "java", label: "Java Lab", color: "#ea580c", bg: "#fff7ed", mono: true, voice: false,
  ...
  {
    id: "aptitude", label: "Aptitude & Reasoning Lab", color: "#0891b2", bg: "#ecfeff", mono: false, voice: false,
  ...
  {
    id: "powerbi", label: "Power BI / Data Lab", color: "#d97706", bg: "#fffbeb", mono: false, voice: false,
...
function LabRunner({ lab, ch, onBack, qIndex, qTotal, isAI, onNext, onNewAI, generating }) {
  ...
  return (
    <div style={PAGE}>
      <ScreenHeader of={lab} color={lab.color} title={ch.title} subtitle={lab.label} onBack={onBack} />
...
function LabsScreen({ onBack }) {
  ...
  return (
    <div style={PAGE}>
      <ScreenHeader art="flask" color="#0891b2" title="AI Practice Labs" subtitle="Hands-on practice with instant AI feedback" onBack={onBack} />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px, 1fr))", gap: 16 }}>
        {LABS.map((l, i) => (
          <button key={l.id} onClick={() => setLab(l)} className="card card-hover" style={{ padding: "22px 20px", textAlign: "left", cursor: "pointer", background: "white", animation: `fadeIn 0.4s ease ${i * 0.05}s both` }}>
            <div style={{ width: 46, height: 46, background: l.bg, borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24, marginBottom: 14 }}><Art of={l} size={30} color={l.color} flat /></div>
    ...
    <div onClick={onClose} style={{ position: "fixed", inset: 0, background: "rgba(15,23,42,0.5)", zIndex: 200, display: "flex", alignItems: "flex-end", justifyContent: "center", padding: 0 }}>
      <div onClick={e => e.stopPropagation()} className="slide-in" style={{ background: "white", borderRadius: "20px 20px 0 0", width: "100%", maxWidth: 620, maxHeight: "90vh", overflowY: "auto", padding: "20px 20px 28px" }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: 12, marginBottom: 12 }}>
          <div style={{ width: 46, height: 46, borderRadius: 12, background: "var(--blue-50)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, flexShrink: 0 }}><Art name="briefcase" size={28} flat /></div>
          <div style={{ flex: 1, minWidth: 0 }}>
  ...
  return (
    <div className="card card-hover" style={{ padding: "16px 18px", cursor: "pointer" }} onClick={() => onOpen(job)}>
      <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
        <div style={{ width: 42, height: 42, borderRadius: 10, background: "var(--blue-50)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 19, flexShrink: 0 }}><Art name="briefcase" size={26} flat /></div>
        <div style={{ flex: 1, minWidth: 0 }}>
...
function JobsScreen({ onBack, onOpen }) {
  ...
  return (
    <div style={PAGE}>
      <ScreenHeader art="briefcase" color="#d97706" title="Job Portal" subtitle="Search · apply · save · track" onBack={onBack} />
        ...
        <>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: 12 }}>
            {filtered.length ? filtered.map(j => <JobCard key={j.id} job={j} saved={isSaved(j.id)} applied={isApplied(j.id)} onOpen={setSel} onToggleSave={toggleSave} />)
              : <div style={{ gridColumn: "1/-1", textAlign: "center", color: "var(--slate-400)", padding: "40px 16px" }}>{allJobs.length === 0 ? <><div style={{ display: "flex", justifyContent: "center", marginBottom: 10 }}><Art name="briefcase" size={40} color="var(--slate-300)" /></div><div style={{ fontWeight: 700, color: "var(--slate-600)", marginBottom: 4 }}>No job openings yet</div><div style={{ fontSize: 13 }}>Your teacher will post openings here soon — check back later.</div></> : "No jobs match your search."}</div>}
          </div>
        </>
      )}
...
Live Class
      ...
      {!host && isLive !== true && (
        <div className="card" style={{ padding: 28, textAlign: "center", marginBottom: 14 }}>
          <div style={{ fontSize: 44, marginBottom: 10 }}><Art name="live" size={44} color="var(--slate-300)" /></div>
            ...
            : <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                {recs.map(r => (
                  <div key={r.id} className="card" style={{ padding: "12px 16px", display: "flex", alignItems: "center", gap: 12 }}>
                    <div style={{ fontSize: 22 }}><Art name="live" size={22} color="#dc2626" flat /></div>
                    <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {started.map(({ c, read, total, pct }) => (
            <button key={c.id} onClick={() => onOpenCourse && onOpenCourse(c.id)} style={{ background: "none", border: "none", padding: 0, textAlign: "left", cursor: "pointer", width: "100%" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
                <span style={{ fontSize: 18 }}><Art of={c} size={18} /></span>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(150px, 1fr))", gap: 10 }}>
            {suggestions.map((c) => (
              <button key={c.id} onClick={() => onOpenCourse && onOpenCourse(c.id)} className="card-hover" style={{ display: "flex", alignItems: "center", gap: 9, padding: "10px 12px", borderRadius: "var(--radius-sm)", border: "1px solid " + c.color + "22", background: c.bg, cursor: "pointer", textAlign: "left" }}>
                <span style={{ fontSize: 20, flexShrink: 0 }}><Art of={c} size={20} /></span>
...
function AdminNotes() {
  ...
  const list = Object.keys(notes).map(k => {
    ...
    return { key: k, cid, tp, title: c ? c.title : cid, text: notes[k] };
  });
    ...
    <div style={{ background: "linear-gradient(135deg,#0f172a 0%,#134e4a 100%)", borderRadius: "var(--radius-xl)", padding: "24px 26px", marginBottom: 24, color: "white", position: "relative", overflow: "hidden" }}>
      ...
      <div onClick={() => onOpen && onOpen("rewards")} className="card-hover" style={{ cursor: "pointer", background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: "var(--radius-lg)", padding: "14px 16px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 10 }}>
          <div style={{ width: 40, height: 40, borderRadius: 11, background: "rgba(255,255,255,0.14)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, flexShrink: 0 }}><Art of={lvl.current} size={26} color="#ffffff" flat /></div>
          <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ fontSize: 11, color: "rgba(255,255,255,0.6)", marginTop: 6 }}>{lvl.next ? `${lvl.next.min - points} pts to ${lvl.next.name}` : "Max level reached"}</div>
      </div>
    </div>
  );
}
    ...
    <div style={{ maxWidth: 820, margin: "0 auto", padding: "0 12px 120px" }}>
      ...
      {messages.length === 0 ? (
        <div className="card" style={{ padding: "24px 20px", marginBottom: 14, textAlign: "center" }}>
          <div style={{ fontSize: 40, marginBottom: 8 }}><Art name="chat" size={40} color="#4338ca" /></div>
